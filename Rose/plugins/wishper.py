...
lengths = 200
IMG = "https://telegra.ph/file/ca44c1590ec11b8900316.jpg"
...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@Solyuibot [@username|@] text`")
        description = "Usage: @Solyuibot [@username|@] text"
        button = InlineKeyboardButton(
            "Learn more...",
            url="https://t.me/Solyuibot?start=learn"
        )
